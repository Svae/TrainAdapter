...
public class ComponentSM extends no.ntnu.item.arctis.runtime.IStateMachine {
    ...
    private no.ntnu.item.arctis.runtime.IStateMachine.Timer _b0_Train_t0;
    private java.lang.String _b0_Train_t0_data;
    ...
    public int fireInitial() {
        ...
        _b0_Train_t0 = new no.ntnu.item.arctis.runtime.IStateMachine.Timer(5000, "_b0_Train_t0", this);
        ...
        if(b011_o0==null) {
            ...
            if(b003_o0==null) {
                ...
                _b0_Train_t0_data = b001_o0;
                scheduler.startOrRestartTimer(_b0_Train_t0);
    ...
    public int fireTimer(java.lang.String _timerID) {
        if(_timerID.equals("_b0_Train_t0")) {
            return handleTimer__b0_Train_t0();
        }
    ...
    public int fire(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.String _signalID, java.lang.Object _data) {
        if(_signalID.equals("TEMPERATUREEVENT_b007")) {
    ...
    private int handleTimer__b0_Train_t0() {
        int b001_o1 = b001.getSpeed();
        if(b002_state==No_ntnu_item_osgi_train_system_MotorController.ACTIVE) {
            b002.setSpeed(b001_o1);
            // step bdff5;
            return CONSUME_SIGNAL;
