...
public class ComponentSM extends no.ntnu.item.arctis.runtime.IStateMachine {
    ...
    private no.ntnu.item.arctis.runtime.IStateMachine.Timer _SimulatedTest_t0;
    ...
    private no.ntnu.item.its.train.adapter.customservicetracker.CustomServiceTracker b002;
    ...
    private enum No_ntnu_item_its_train_adapter_CustomServiceTracker {ACTIVE, _IDLE};
    ...
    private enum No_ntnu_item_its_train_adapter_RemoteControl {_IDLE, ACTIVE, INITIALIZING};
    private No_ntnu_item_its_train_adapter_TrainAdapter b001_state;
    private No_ntnu_item_its_train_adapter_CustomServiceTracker b002_state;
    ...
    public int fireInitial() {
        ...
        b002 = new no.ntnu.item.its.train.adapter.customservicetracker.CustomServiceTracker();
        ...
        b002_state = No_ntnu_item_its_train_adapter_CustomServiceTracker._IDLE;
        ...
        _SimulatedTest_t0 = new no.ntnu.item.arctis.runtime.IStateMachine.Timer(10000, "_SimulatedTest_t0", this);
        org.osgi.framework.BundleContext b008_o0 = b008.get();
        if(b008_o0==null) {
            java.lang.String b008_o1 = b008.errMsg();
            b000.logError(b008_o1);
            scheduler.startOrRestartTimer(_SimulatedTest_t0);
            ...
            if(b007_o0==null) {
                ...
                b006_FAILED_r8 = false;
                scheduler.flushEventQueue(sessionID, "FAILED_b006");
                b006_ADDTOPIC_r4 = false;
                ...
                b006_RECONFIGURESENSOR_r9 = false;
                scheduler.flushEventQueue(sessionID, "RECONFIGURESENSOR_b006");
                b006_UPDATEHANDLER_r7 = false;
                scheduler.flushEventQueue(sessionID, "UPDATEHANDLER_b006");
                b006_SPEED_r0 = false;
                ...
                if(b010_o0==null) {
                    ...
                    b006_RECONFIGURESENSOR_r9 = true;
                    b006_UPDATEHANDLER_r7 = true;
                    b006_SPEED_r0 = true;
                    b002_state = No_ntnu_item_its_train_adapter_CustomServiceTracker._IDLE;
                    b005_state = Com_bitreactive_library_osgi_GetBundleContext._IDLE;
                    b003_state = Com_bitreactive_library_osgi_GetBundleContext._IDLE;
    ...
    public int fireTimer(java.lang.String _timerID) {
        if(_timerID.equals("_SimulatedTest_t0")) {
            return handleTimer__SimulatedTest_t0();
        }
    ...
    public int fire(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.String _signalID, java.lang.Object _data) {
        if(_signalID.equals("TEMPERATUREEVENT_b004")) {
        ...
        } else if(_signalID.equals("FAILED_b006")) {
            return handleEvent_FAILED_b006(_sender, receiverSessionID, _data);
        ...
        } else if(_signalID.equals("RECONFIGURESENSOR_b006")) {
            return handleEvent_RECONFIGURESENSOR_b006(_sender, receiverSessionID, _data);
        ...
        } else if(_signalID.equals("UPDATEHANDLER_b006")) {
            return handleEvent_UPDATEHANDLER_b006(_sender, receiverSessionID, _data);
    ...
    private int handleTimer__SimulatedTest_t0() {
        if(b001_state==No_ntnu_item_its_train_adapter_TrainAdapter._IDLE) {
            // step 3192d;
            return CONSUME_SIGNAL;
        } else if(b001_state==No_ntnu_item_its_train_adapter_TrainAdapter.INITIALIZING) {
            // step a2daa;
            return CONSUME_SIGNAL;
        } else if(b001_state==No_ntnu_item_its_train_adapter_TrainAdapter.ACTIVE) {
            b002.stop();
            b004.stop();
            if(b009_state==No_ntnu_item_its_train_adapter_RemoteControl.ACTIVE) {
                b009.stop();
                b006.stop();
                // step 3ff5d;
    ...
    private int handleEvent_ADDTOPIC_b006(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b006_ADDTOPIC_r4) {
            if(b009_state==No_ntnu_item_its_train_adapter_RemoteControl._IDLE) {
                // step ae83d;
                return CONSUME_SIGNAL;
                ...
                // step a5fa1;
                return CONSUME_SIGNAL;
            } else if(b009_state==No_ntnu_item_its_train_adapter_RemoteControl.INITIALIZING) {
                // step 4fd4b;
                return CONSUME_SIGNAL;
            } else {
                return DISCARD_SIGNAL;
    ...
    private int handleEvent_CHANGEFILTER_b006(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b006_CHANGEFILTER_r6) {
            if(b002_state==No_ntnu_item_its_train_adapter_CustomServiceTracker.ACTIVE) {
                b002.startListener(((java.lang.String) _data));
                // step 72f41;
                return CONSUME_SIGNAL;
            } else if(b002_state==No_ntnu_item_its_train_adapter_CustomServiceTracker._IDLE) {
                // step 0c0a3;
                return CONSUME_SIGNAL;
            } else {
                return DISCARD_SIGNAL;
    ...
    private int handleEvent_INVALID_b002(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b002_INVALID_r3) {
            b000.logError(((java.lang.String) _data));
            b004_ACCELEROMETEREVENT_r6 = false;
            b004_COLOREVENT_r0 = false;
            b006_ADDTOPIC_r4 = false;
            b004_SENSORSTATEEVENT_r3 = false;
    ...
    private int handleEvent_FAILED_b006(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b006_FAILED_r8) {
            if(b001_state==No_ntnu_item_its_train_adapter_TrainAdapter.INITIALIZING) {
                b000.logError(((java.lang.String) _data));
                b002_MODIFIED_r2 = false;
                ...
                if(b006.runWithoutRemote()) {
                    ...
                    if(b005_o0==null) {
                        ...
                        if(b003_o0==null) {
                            ...
                            b002_state = No_ntnu_item_its_train_adapter_CustomServiceTracker.ACTIVE;
                            b009_state = No_ntnu_item_its_train_adapter_RemoteControl._IDLE;
                            b004_state = No_ntnu_item_its_train_adapter_SensorController.ACTIVE;
                            // step a3d58;
                            return CONSUME_SIGNAL;
    ...
    private int handleEvent_SENSORSTATEEVENT_b004(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b004_SENSORSTATEEVENT_r3) {
            b006.handleSensorStateEvent(((no.ntnu.item.its.osgi.train.adapter.handlers.common.readings.SensorStateEvent) _data));
            // step 418ac;
            return CONSUME_SIGNAL;
        } else {
            return DISCARD_SIGNAL;
    ...
    private int handleEvent_RECONFIGURESENSOR_b006(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b006_RECONFIGURESENSOR_r9) {
            if(b004_state==No_ntnu_item_its_train_adapter_SensorController.ACTIVE) {
                b004.reconfigureSensor(((no.ntnu.item.its.osgi.train.adapter.sensorconfigurator.common.SensorReconfiguration) _data));
                // step 6bdb4;
                return CONSUME_SIGNAL;
            } else if(b004_state==No_ntnu_item_its_train_adapter_SensorController._IDLE) {
                // step 44290;
                return CONSUME_SIGNAL;
            } else {
                return DISCARD_SIGNAL;
    ...
    private int handleEvent_UPDATEHANDLER_b006(java.lang.Object _sender, java.lang.Object receiverSessionID, java.lang.Object _data) {
        if(b006_UPDATEHANDLER_r7) {
            if(b004_state==No_ntnu_item_its_train_adapter_SensorController.ACTIVE) {
                b004.externalUpdate(((no.ntnu.item.its.osgi.common.enums.PublisherType) _data));
                // step 8cbd3;
                return CONSUME_SIGNAL;
            } else if(b004_state==No_ntnu_item_its_train_adapter_SensorController._IDLE) {
                // step 1feef;
